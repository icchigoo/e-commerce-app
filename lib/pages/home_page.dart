// ignore_for_file: unnecessary_new, prefer_const_constructors, prefer_const_literals_to_create_immutables, sized_box_for_whitespace, non_constant_identifier_names
      ...
      body: Column(
        children: <Widget>[
          ...
          new Padding(
            ...
            child: Container(
                alignment: Alignment.center, child: new Text('Categories')),
          ),
